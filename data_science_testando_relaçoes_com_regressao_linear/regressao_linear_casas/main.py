...
modelo_3 = sm.OLS(y_train, x_train[['const','area_primeiro_andar','existe_segundo_andar','quantidade_banheiros','qualidade_da_cozinha_Excelente']]).fit()
...
# print("R²")
# print("Modelo 0: ", modelo_0.rsquared) # Para verificar o valor de R² do modelo, quanto mais próximo de 1 melhor o modelo se encaixa aos dados.
